...
extern int up_add_monitor_point(const char *name);
extern void up_remove_monitor_point(const char *name);
...
static inline int up_add_monitor_point(const char *name) 
{
	return 0;
}

static inline void up_remove_monitor_point(const char *name)
{
}
